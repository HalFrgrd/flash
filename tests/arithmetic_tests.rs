...
fn test_arithmetic_expansion_with_variables() {
    ...
    interpreter
        .variables
        .insert("a".to_string(), "10".to_string());
    interpreter
        .variables
        .insert("b".to_string(), "5".to_string());
...
fn test_arithmetic_command_with_variables() {
    ...
    interpreter
        .variables
        .insert("y".to_string(), "5".to_string());
...
fn test_arithmetic_increment_decrement() {
    ...
    interpreter
        .variables
        .insert("i".to_string(), "5".to_string());
...
fn test_arithmetic_complex_expressions() {
    ...
    interpreter
        .variables
        .insert("c".to_string(), "2".to_string());
...
fn test_complex_nested_arithmetic() {
    ...
    interpreter
        .variables
        .insert("a".to_string(), "3".to_string());
    interpreter
        .variables
        .insert("b".to_string(), "4".to_string());
